...
- **A touch of cyberpunk, contained to the logs** — monospace, glowing-green-on-black terminal styling for the Advisory Feed and Audit Ledger specifically, reinforcing "autonomous agent" without letting it spread into the data-legibility-critical charts.
